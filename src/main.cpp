...
uint256 hashGenesisBlock("0x5b08cbe328392be8151f5deec2dc92e7609dcbd20e0dac335904ccf538df68e8");
...
int64 nSubsidy = 20 * COIN;
    ...
    nSubsidy >>= (nHeight / 525600); // Approx .5 million blocks per year

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 30 * 60; // Pokercoin: Every 600 Blocks.
static const int64 nTargetSpacing = 60; // Pokercoin: 30 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x5b08cbe328392be8151f5deec2dc92e7609dcbd20e0dac335904ccf538df68e8");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Royal Flush is the key 2013";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1373024539; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 345495;

        if (fTestNet)
        {
            block.nTime    = 1373024539;
            block.nNonce   = 345495;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x07a9b2f9cb8d17d94c66181857bb9bbea9e3180fe793ffcc98ccd9ea6c91965a"));
